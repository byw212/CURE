...
class DINOHead(nn.Module):
    def __init__(self, in_dim, out_dim, use_bn=False, norm_last_layer=True, 
                 nlayers=3, hidden_dim=2048,hidden_dim1=1024, bottleneck_dim=256):
        super().__init__()
...
class DistillLoss(nn.Module):
    ...
    def forward(self, student_output, teacher_output,log_prior, epoch):
        """
        ...
        for iq, q in enumerate(teacher_out):
            for v in range(len(student_out)):
                ...
                loss = torch.sum(-q * F.log_softmax(student_out[v]+log_prior, dim=-1), dim=-1)
